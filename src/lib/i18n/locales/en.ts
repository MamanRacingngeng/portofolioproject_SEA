export const en = {
  ...
  common: {
    ...
    tapForColor: "Tap for color",
    portraitAlt: "Food Technology Student",
    portraitAriaSuffix: "tap to reveal full color",
    step: "Step",
    overview: "Overview",
  ...
  site: {
    ...
    heroIntro: {
      beforeEmphasis: "Food Technology Student & Patent Inventor. Inventor of",
  ...
  home: {
      ...
      highlights: [
        {
          ...
          description:
            "Food Technology undergraduate at Ahmad Dahlan University, Class of 2022. Active in research and laboratory practicum.",
        },
        {
          num: "02",
    ...
    projects: {
      ...
      description:
        "Flagship research — from the sacha inchi natto patent to local food diversification.",
      allProjects: "All projects",
    },
    skills: {
      index: "07",
      ...
      description:
        "Food analysis, processing, safety systems, and the lab equipment behind the work.",
    ...
    cta: {
      ...
      quoteContext:
        "Open to R&D roles, fermentation research collaborations, and product development opportunities in food technology.",
      rightTitle: "Work together?",
      rightDescription:
        "Send a message about research, internships, or product development — I'll get back to you.",
  ...
  footer: {
    ...
    crafted: "Crafted with scientific precision",
  ...
  pages: {
    career: {
      ...
      description:
        "Academic achievements, professional certifications, and patent publications in food science and technology.",
      metaDescription:
    ...
    contact: {
      ...
      title: "Let's Connect",
      description:
        "Interested in collaborating on food research, fermentation innovation, or product development? I'd love to hear from you.",
      formDescription:
      ...
      form: {
        ...
        subjectPlaceholder: "Job opportunity, collaboration, etc.",
        messagePlaceholder: "Tell me about your opportunity or inquiry...",
      },
      success: {
        title: "Message Sent!",
        message:
    ...
    projects: {
      ...
      description:
        "Detailed case studies showcasing food science research, product development, quality analysis, and food safety projects.",
    },
    blog: {
      label: "Insights",
      title: "Food Science Blog",
      description:
        "Articles on food science, safety, innovation, processing, and career insights for food technology professionals.",
    },
    notFound: {
  ...
  projects: {
    categories: {
      all: "All",
      foodProductDevelopment: "Food Product Development",
      fermentationResearch: "Fermentation Research",
...
Through patent invention, we hope to inspire further development of innovative local food products — supporting farmers, the food industry, and community nutrition.`,
      ...
      "patent-simple-food-invention": {
        title: "Understanding Simple Patents for Food Product Inventions",
        excerpt:
