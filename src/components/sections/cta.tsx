  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-[1] grid grid-cols-1 lg:grid-cols-2">
        ...
        <RevealOnScroll delay={0.1} className="band-mint relative flex flex-col justify-center overflow-hidden px-6 py-14 text-white sm:px-10 sm:py-20 lg:py-24">
          <FloatingField variant="page" />
          <FloatingElement y={12} duration={5.5} delay={0.2} className="relative z-[1]">
            <>
